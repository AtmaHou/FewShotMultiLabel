...
#cross_data_id_lst=(0)
cross_data_id_lst=(0 1)  # for stanford
                                                ...
                                                do
                                                    ...
                                                    do
                                                        ...
                                                        do
                                                            ...
                                                            do
                                                                for meta_rate in ${meta_rate_lst[@]}
                                                                do
                                                                    for cross_data_id in ${cross_data_id_lst[@]}
                                                                    do
                                                                        # model names
                                                                        model_name=electra.best.ple_${ple_scale_r}.bandwidth_${bandwidth}.up_lr_${upper_lr}.bs_${train_batch_size}.${task}.sim_${similarity}.dec_${decoder}.ems_${emission}_${emission_normalizer}.mr_${meta_rate}.t_${threshold}_type_${threshold_type}.fm_${feature_num}_${feature_map_dim}${feature_map}${use_schema}${label_num_schema}${do_debug}
