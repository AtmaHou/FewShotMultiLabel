...
feature_map_act_lst=(relu)
feature_map_layer_num_lst=(2)
                                                    ...
                                                    do
                                                        ...
                                                        do
                                                            ...
                                                            do
                                                                ...
                                                                do
                                                                    for feature_map_act in ${feature_map_act_lst[@]}
                                                                    do
                                                                        for feature_map_layer_num in ${feature_map_layer_num_lst[@]}
                                                                        do
                                                                            # model names
                                                                            model_name=electra.best.f_ly_${feature_map_layer_num}_${feature_map_act}.ga_${grad_acc}_ple_${ple_scale_r}.bs_${train_batch_size}.kernel_${kernel}.bd_${bandwidth}.${task}.sim_${similarity}.dec_${decoder}.ems_${emission}_${emission_normalizer}.mr_${meta_rate}.t_${threshold}_type_${threshold_type}.fm_${feature_num}_${feature_map_dim}${feature_map}${use_schema}${label_num_schema}${do_debug}

                                                                            data_dir=${base_data_dir}${dataset}.${cross_data_id}.spt_s_${support_shots}.q_s_${query_set}.ep_${episode}${use_schema}${label_num_schema}2/
                                                                            ...
                                                                            CUDA_VISIBLE_DEVICES=${gpu_list} python main.py ${do_debug} \
                                                                                ...
                                                                                --feature_map_layer_num ${feature_map_layer_num} \
                                                                                --bandwidth ${bandwidth} \
                                                                                --kernel ${kernel} \
                                                                                ...
                                                                                > ./log/${model_name}.DATA.${file_mark}.log
                                                                            echo [CLI]
                                                                            echo Model: ${model_name}
                                                                            echo Task:  ${file_mark}
                                                                            echo [CLI]
