                                                    ...
                                                    do
                                                        ...
                                                        do
                                                            ...
                                                            do
                                                                ...
                                                                do
                                                                    # model names
                                                                    model_name=bert.best.ple_${ple_scale_r}.gs_${grad_acc}.bs_${train_batch_size}.bandwidth_${bandwidth}.${task}.sim_${similarity}.dec_${decoder}.ems_${emission}_${emission_normalizer}.mr_${meta_rate}.t_${threshold}_type_${threshold_type}.fm_${feature_num}_${feature_map_dim}${feature_map}${use_schema}${label_num_schema}${do_debug}
